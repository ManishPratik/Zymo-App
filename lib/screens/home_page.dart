                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                // Grey container for both text and carousel
                                Container(
                          ...
                          //     title: AppData.allCategories.first['title'],
                          //     image: AppData.allCategories.first['image'],
                          //     function: () => Navigator.pushNamed(
                          //         context,
                          //         AppData.allCategories
                          //             .first['title']), //  url: e['url'],
                          //   ),
                          // ),
                          // Center(
                          //     child: Wrap(
                          //         children: AppData.allCategories.map((e) {
                          //   if (e['title'] != 'Self Drive Cars')
                          //     return AllCategoryWidget(
                          //       title: e['title'],
                          //       image: e['image'],
                          //       function: () => Navigator.pushNamed(
                          //           context, e['title']), //  url: e['url'],
                          //     );
                          //   else
                          //     return Container();
                          // }).toList())),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          //     onPressed: () => Auth()
          //         .signOut()
          //         .then((value) => CommonFunctions.navigateTo(context, TabScreen())),
          //     child: Row(
          //       mainAxisAlignment: MainAxisAlignment.center,
          //       children: const [
          //         Icon(
...
//             child: Text('Our Customers Love Us',
//                 style: TextStyle(
//                   fontSize: 18,
//                   fontWeight: FontWeight.bold,
//                 )),
//           ),
//           const Text('We love hearing from happy customers',
//               style: TextStyle(
//                 fontSize: 11,
//               )),
...
//               items: <Widget>[
//                 Image.asset(
//                   'assets/images/Reviews/review.jpeg',
//                   height: .15.sh,
//                   width: .8.sw,
//                 ),
//                 Image.asset(
//                   'assets/images/Reviews/review1.jpeg',
//                   height: .15.sh,
//                   width: .8.sw,
//                 ),
//                 Image.asset(
//                   'assets/images/Reviews/review2.jpeg',
//                   height: .15.sh,
//                   width: .8.sw,
//                 ),
//                 Image.asset(
//                   'assets/images/Reviews/review3.jpeg',
//                   height: .15.sh,
//                   width: .8.sw,
//                 ),
//               ],
