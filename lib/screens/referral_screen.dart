                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 20),
                          Text('Invite using link', style: whiteTitleStyle),
                        ],
                      ),
                      ...
                      InputDecorator(
                        ...
                        child: Text(snapshot.data!, style: whiteTitleStyle),
                      ),
                      SizedBox(height: .03.sh),
                      Row(
                        children: [
                      ...
                      ElevatedButton(
                        ...
                        child: Text("Share Link", style: largeBlackStyle),
                      ),
                    ],
                  ),
                ),
      ...
      child: InkWell(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(text, style: smallWhiteText,)
          ],
        ),
      ),
    );
