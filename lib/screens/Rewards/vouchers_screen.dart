...
class VoucherWidget extends StatelessWidget {
  ...
  VoucherWidget({Key? key, this.type}) : super(key: key);
  @override
  Widget build(BuildContext context) {
...
class VoucherTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isApplicable = type != null &&
        (type == validFor || validFor == 'any' || validFor == 'all') &&
        !isExpired &&
                    ...
                    if (isExpired)
                      ...
                      Align(
                        ...
                        child: Chip(
                          ...
                          backgroundColor:
                              isApplicable ? appColor : Colors.grey,
                        ),
                      ),
                  ],
                )
