...
class LowCarServices {
    ...
    try {
      ...
      data.forEach((car) {
        ...
        cars.add(CarModel()
          ...
          ..finalDiscount = model.offerPrice! * (vendor.currentRate as double)
  ...
  static Future createBooking(
    ...
    final bookingData = {
      ...
      'car_id': carModel.carId!,
      'fleet_id': carModel.selectedPickup.locationId!,
      'package': carModel.packageName,
      'allowed_km': '${carModel.freeKm}',
      'booking_charge': '${carModel.actualPrice}'
    };
    try {
