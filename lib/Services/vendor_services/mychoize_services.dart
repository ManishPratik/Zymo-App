...
class MyChoizeServices {
  ...
  static Future<List<MyChoizeModel>> getSd(DriveModel model, Vendor vendor,
    ...
    const baseUrl = 'https://app.mychoize.com/ORIX.MobileBookingLive';
...
//   // Updated base URLs
    ...
    //     'https://orixiddriveuat.orixindia.com/OrixMobileAppThirdParty/';
    //  const String _newSearchEndpoint =
    ...
    print('inside getSddddddd');
    try {
      print('inside try of getSddddddd');
      ...
      print('initialising MYCHOIZE data');
      ...
      print('MYCHOIZE data: $data');
      if (data['SearchBookingModel'] != null) {
        //not going inside this if statement

        print('inside if statement of mychoizeeeee');
        data['SearchBookingModel'].forEach((car) {
          ...
          if (myChoizeModel.rateBasis != 'MLK' &&
            ...
            print('myChoizeModel: ${myChoizeModel.brandName}');
            myChoizeModel.rateBasisDesc =
                getMyChoizePackage(myChoizeModel.rateBasis, tripDurationHours);
            cars.add(myChoizeModel);
          }
        });
        print('mychoize if statement successfull');
      }
      print('mychoizeeeee try successfull');
    } catch (e) {
      print('Error in mychoizeeeee: $e');
    }
    return cars;
  }
