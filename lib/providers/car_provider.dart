...
List<int> getRemainingDuration(DateTime start, DateTime end, TimeOfDay endT, TimeOfDay startT) {
  ...
  if (endDateTime.isBefore(startDateTime)) {
    return [0, 0]; // Return 0 for days and hours if the duration is negative
  }
