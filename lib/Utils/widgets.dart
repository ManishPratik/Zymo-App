          ...
          builder: (BuildContext context, value, Widget? child) => Column(
            ...
            children: <Widget>[
              DocumentWidget(
                ...
                description: 'Driving License Front Page',
              ...
              DocumentWidget(
                ...
                description: 'Driving License Back Page',
              ...
              DocumentWidget(
                ...
                description: 'Aadhaar card Front Page',
              ...
              DocumentWidget(
                ...
                description: 'Aadhaar card back page',
...
//     else { final storageRef = FirebaseStorage.instance
//           .ref()
...
//         _errorOccurred = true;
//           //      if (!widget.file.existsSync()) {
//           // _errorMessage = 'Please upload the file';}
// // else
    ...
    return Column(
      children: [
        Icon(
          icon,
          size: 40,
          color: accentColor, // Light yellow-green
        ),
