...
const AppsFlyerKey = "tLS3WHzRuhaNxgyRRFU9W7";
...
class AppData {
  ...
  static const List<Map<String, String>> allCategories = [
    {
      ...
      'image': 'assets/images/Tips&Tricks/Day Booking.png',
      'url': 'https://letzrent.com/self-drive-car-for-rent/'
    },
    {
      'title': 'Monthly Car Rental',
      'image': 'assets/images/Tips&Tricks/Monthly Booking.png',
      'url':
  ...
  static const List<Map<String, String>> buyOptions = [
    {
      'title': 'New Cars',
      'imageUrl': 'assets/images/newcars.png',
      'description': '2000 + variants'
    },
    {
      'title': 'Used Cars',
      'imageUrl': 'assets/images/usedcars.jpg',
